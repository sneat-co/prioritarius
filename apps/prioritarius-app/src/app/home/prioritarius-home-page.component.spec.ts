...
import { PrioritariusHomePageComponent } from './prioritarius-home-page.component';
...
describe('PrioritariusHomePageComponent', () => {
  ...
  beforeEach(() =>
    TestBed.configureTestingModule({
      imports: [PrioritariusHomePageComponent],
      providers: [
  ...
  it('renders the spaces list for a user with spaces (all DI resolves, no NG0201)', () => {
    const fixture = TestBed.createComponent(PrioritariusHomePageComponent);
