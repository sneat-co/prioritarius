...
// Authenticated landing page for prioritarius.app. Reuses the shared
...
@Component({
  selector: 'prioritarius-home-page',
  imports: [
    IonHeader,
    IonToolbar,
    IonTitle,
  ...
  template: `
    <ion-header>
      <ion-toolbar>
        ...
        <ion-title>Prioritarius.app</ion-title>
      </ion-toolbar>
    </ion-header>
...
export class PrioritariusHomePageComponent {}
