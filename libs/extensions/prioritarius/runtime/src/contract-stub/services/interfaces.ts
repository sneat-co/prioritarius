...
// export abstract class IListService extends ICommuneItemService<IListDto, PrioritariusAppSchema, typeof ListKind> {
// 	abstract deleteList(listId: string, communeId: string): Observable<IListDto>;
// }
//
// export abstract class IListItemService extends ICommuneItemService<IListItemDto, PrioritariusAppSchema, typeof ListItemKind> {
// 	// noinspection JSUnusedGlobalSymbols
// 	// abstract txRemoveKinds(): string[];
//
// 	// noinspection JSUnusedGlobalSymbols
// 	abstract selectByListId(tx: IRxReadonlyTransaction<PrioritariusAppSchema>, listId: string, status?: ListStatus)
...
// export abstract class IPrioritariusService extends RxStoreService<PrioritariusAppSchema> {
